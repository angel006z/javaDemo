...
import com.meida.generatefront.config.DataSourceConfig;
import com.meida.generatefront.config.GlobalConfig;
import com.meida.generatefront.config.PackageConfig;
import com.meida.generatefront.config.StrategyConfig;
import com.meida.generatefront.config.rules.DbType;
import com.meida.generatefront.config.rules.NamingStrategy;
...
public class FrontSqlGenerator {
    ...
    private static String basePackage = "com.meida.testpay";  //包名  示例：com.meida.backend.userManager
