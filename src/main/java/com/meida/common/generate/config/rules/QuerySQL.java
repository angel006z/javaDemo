...
public enum QuerySQL {
    ...
    MYSQL("mysql", "show tables", "show table status",
            ...
            "NAME", "COMMENT", "FIELD", "TYPE", "COMMENT", "KEY", "isAuto"),//mysql主键是否自动增长暂未修改
    ...
    QuerySQL(final String dbType, final String tablesSql, final String tableCommentsSql,
             ...
             final String fieldType, final String fieldComment, final String fieldKey, final String isAuto) {
        this.dbType = dbType;
