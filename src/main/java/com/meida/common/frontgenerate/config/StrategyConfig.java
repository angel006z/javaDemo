...
public class StrategyConfig {
	 ...
	 */
	private String superSubmitDtoClass = com.meida.common.backendgenerate.config.ConstVal.SUPERD_SUBMITDTO_CLASS;
	/**
	 * 自定义继承的SubmitParamDto类全称，带包名
	 */
	private String superSubmitParamDtoClass = com.meida.common.backendgenerate.config.ConstVal.SUPERD_SUBMITPARAMDTO_CLASS;

	/**
	 * 自定义继承的Dao类全称，带包名
	 */
	private String superDaoClass = com.meida.common.backendgenerate.config.ConstVal.SUPERD_DAO_CLASS;
	/**
	 * 自定义继承的DaoImpl类全称，带包名
	 */
	private String superDaoImplClass = com.meida.common.backendgenerate.config.ConstVal.SUPERD_DAOIMPL_CLASS;

	/**
	 * 自定义继承的Service类全称，带包名
	 */
	private String superServiceClass = com.meida.common.backendgenerate.config.ConstVal.SUPERD_SERVICE_CLASS;
