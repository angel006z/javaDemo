...
public class PropertyUtils {
    ...
    public static void copyProperties(Object dest, Object src) {
        ...
        for (String property : srcPropertyNames) {
            ...
            if (!(value instanceof Map) && !(value instanceof Collection) && StringUtils.isStringInArray(property, destNames)) {
				...
				for (int j = 0; j < method2.length; j++) {
					...
					if (methodName2.startsWith(SET)) {
						if (methodFix2.equals(methodFix1)) {
							...
							try {
								objs2[0] = method1[i].invoke(src, objs1);// 激活src的相应的get的方法，objs1数组存放调用该方法的参数,此例中没有参数，该数组的长度为0
								if (!(objs2[0] instanceof Map) && !(objs2[0] instanceof Collection)) {
									method2[j].invoke(dest, objs2);// 激活dest的相应的set的方法，objs2数组存放调用该方法的参数
								}
							} catch (Exception e) {
								LOG.warn("属性复制失败！");
							}
    ...
    public static void copyPropertiesIgnore(Object dest, Object src, String[] ignore) {
        ...
        for (String property : srcPropertyNames) {
            Object value = getValue(src, property);
            if (!(value instanceof Map) && !(value instanceof Collection) && StringUtils.isStringInArray(property, destNames)) {
                if (!StringUtils.isStringInArray(property, ignore)) {
                    setValue(dest, property, value);
                }
            }
        }
    ...
    public static void copyProperties(Object dest, Object src, String[] include) {
        ...
        for (String property : srcPropertyNames) {
            Object value = getValue(src, property);
            if (!(value instanceof Map) && !(value instanceof Collection) && StringUtils.isStringInArray(property, destNames)) {
                if (StringUtils.isStringInArray(property, include)) {
                    setValue(dest, property, value);
                }
            }
        }
    ...
    public static void copyNotNullProperties(Object dest, Object src) {
        /*if (dest != null && src != null) {
            ...
            for (String property : properties) {
                Object value = getValue(src, property);
                if (value != null && StringUtils.isStringInArray(property, destNames)) {
                    setValue(dest, property, value);
                }
            }
        }*/
    ...
    public static void copyPropertiesIfNull(Object dest, Object src) {
        if (dest != null && src != null) {
            ...
            for (String property : properties) {
                ...
                if (destValue == null && StringUtils.isStringInArray(property, destNames)) {
    ...
    public static void copyNotNullPropertiesIgnore(Object dest, Object src, String[] ignore) {
        if (dest != null && src != null) {
            ...
            for (String property : properties) {
                Object value = getValue(src, property);
                if (value != null && StringUtils.isStringInArray(property, destNames) && !StringUtils.isStringInArray(property, ignore)) {
                    setValue(dest, property, value);
                }
            }
        }
    ...
    public static Class getPropertyClass(Object obj, String property) {
        String[] propertyNames = getPropertyNames(obj);
        if (!StringUtils.isStringInArray(property, propertyNames)) {
            return null;
        } else {
