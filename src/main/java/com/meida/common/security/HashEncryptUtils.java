...
public class HashEncryptUtils {
    ...
    public static void main(String[] args) {
        System.out.println("admin:" + HashEncryptUtils.backendPassword(MD5Utils.md5("admin")));
        System.out.println("111111:" + HashEncryptUtils.backendPassword(MD5Utils.md5("111111")));
    }
}
