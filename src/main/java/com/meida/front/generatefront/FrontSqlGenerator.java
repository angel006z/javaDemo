package com.meida.front.generatefront;
...
public class FrontSqlGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        gc.setFileOverride(false);//是否覆盖现有文件
        gc.setAuthor(auth);
...
//        strategy.setSuperServiceImplClass("com.meida.base.service.impl.BaseServiceImpl");
        // 自定义 Dao 类父类
        strategy.setSuperDaoClass("com.meida.front.base.dao.inter.BaseDao");
//        // 自定义 Dao 实现类父类
