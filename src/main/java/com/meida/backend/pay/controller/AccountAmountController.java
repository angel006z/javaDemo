 ...
 */
@Controller("backendAccountAmountController")
@RequestMapping("/backend/pay/accountAmount")
public class AccountAmountController {
	...
	@RequestMapping("/list")
	public String list() {
        return "/backend/pay/AccountAmount/list";
	}

	@RequestMapping("/detail")
	public String detail() {
        return "/backend/pay/AccountAmount/detail";
    }
	...
	public String enableOperate(@RequestBody EnableParamDto paramDto) {
		...
		boolean isFlag = accountAmountService.enable(enableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String disableOperate(@RequestBody DisableParamDto paramDto) {
		...
		boolean isFlag = accountAmountService.disable(disableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String PhysicalDeleteOperate(@RequestBody PhysicalDeleteParamDto paramDto) {
		...
		boolean isFlag = accountAmountService.physicalDelete(physicalDeleteDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
