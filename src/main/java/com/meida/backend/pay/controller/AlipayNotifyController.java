 ...
 */
@Controller("backendAlipayNotifyController")
@RequestMapping("/backend/pay/alipayNotify")
public class AlipayNotifyController {
	...
	@RequestMapping("/list")
	public String list() {
        return "/backend/pay/AlipayNotify/list";
	}

	@RequestMapping("/detail")
	public String detail() {
        return "/backend/pay/AlipayNotify/detail";
    }
	...
	@ResponseBody
	public String searchList(@RequestBody AlipayNotifyListParamDto paramDto) {
		ResultMessage resultValidate = ValidatorUtils.validateEntity(paramDto);
		if (!resultValidate.getCode().equals(EErrorCode.Success)) {
			return JsonUtils.toJSONString(resultValidate);
		}
		...
		AlipayNotifyListDto whereItemDto = new AlipayNotifyListDto();
		whereItemDto.setCurrentUserDto(BackendUtils.getCurrentUserDto());
		whereItemDto.setPagination(paramDto.getPagination());
		   		whereItemDto.setNotifyTime(paramDto.getNotifyTime());
	   		whereItemDto.setNotifyType(paramDto.getNotifyType());
	   		whereItemDto.setNotifyId(paramDto.getNotifyId());
	   		whereItemDto.setCharset(paramDto.getCharset());
	   		whereItemDto.setVersion(paramDto.getVersion());
	   		whereItemDto.setSignType(paramDto.getSignType());
	   		whereItemDto.setSign(paramDto.getSign());
	   		whereItemDto.setAuthAppId(paramDto.getAuthAppId());
	   		...
	   		whereItemDto.setOutBizNo(paramDto.getOutBizNo());
	   		whereItemDto.setBuyerId(paramDto.getBuyerId());
	   		whereItemDto.setSellerId(paramDto.getSellerId());
	   		whereItemDto.setTradeStatus(paramDto.getTradeStatus());
	   		whereItemDto.setTotalAmount(paramDto.getTotalAmount());
	   		whereItemDto.setReceiptAmount(paramDto.getReceiptAmount());
	   		whereItemDto.setInvoiceAmount(paramDto.getInvoiceAmount());
	   		whereItemDto.setBuyerPayAmount(paramDto.getBuyerPayAmount());
	   		whereItemDto.setPointAmount(paramDto.getPointAmount());
	   		whereItemDto.setRefundFee(paramDto.getRefundFee());
	   		whereItemDto.setSubject(paramDto.getSubject());
	   		whereItemDto.setBody(paramDto.getBody());
	   		whereItemDto.setGmtCreate(paramDto.getGmtCreate());
	   		whereItemDto.setGmtPayment(paramDto.getGmtPayment());
	   		whereItemDto.setGmtRefund(paramDto.getGmtRefund());
	   		whereItemDto.setGmtClose(paramDto.getGmtClose());
	   		whereItemDto.setFundBillList(paramDto.getFundBillList());
	   		whereItemDto.setVoucherDetailList(paramDto.getVoucherDetailList());
	   		whereItemDto.setPassbackParams(paramDto.getPassbackParams());
		...
		List<AlipayNotifyInfo> list = alipayNotifyService.getListPage(whereItemDto);
	...
	public String initSingle(@RequestBody SingleParamDto paramDto) {
		...
		AlipayNotifyInfo item = alipayNotifyService.getObjectById(paramDto.getId());
	...
	@ResponseBody
	public String submitOperate(@RequestBody AlipayNotifySubmitParamDto paramDto) {
		ResultMessage resultValidate = ValidatorUtils.validateEntity(paramDto);
		if (!resultValidate.getCode().equals(EErrorCode.Success)) {
			return JsonUtils.toJSONString(resultValidate);
		}
		...
		AlipayNotifySubmitDto submitDto = new AlipayNotifySubmitDto();
		...
		boolean isFlag = alipayNotifyService.submit(submitDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
	...
	public String deleteOperate(@RequestBody DeleteParamDto paramDto) {
		...
		boolean isFlag = alipayNotifyService.delete(deleteDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String enableOperate(@RequestBody EnableParamDto paramDto) {
		...
		boolean isFlag = alipayNotifyService.enable(enableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String disableOperate(@RequestBody DisableParamDto paramDto) {
		...
		boolean isFlag = alipayNotifyService.disable(disableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String PhysicalDeleteOperate(@RequestBody PhysicalDeleteParamDto paramDto) {
		...
		boolean isFlag = alipayNotifyService.physicalDelete(physicalDeleteDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
