 ...
 */
@Controller("backendAccountRefundController")
@RequestMapping("/backend/pay/accountRefund")
public class AccountRefundController {
	...
	@RequestMapping("/list")
	public String list() {
        return "/backend/pay/AccountRefund/list";
	}

	@RequestMapping("/detail")
	public String detail() {
        return "/backend/pay/AccountRefund/detail";
    }
	...
	public String enableOperate(@RequestBody EnableParamDto paramDto) {
		...
		boolean isFlag = accountRefundService.enable(enableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String disableOperate(@RequestBody DisableParamDto paramDto) {
		...
		boolean isFlag = accountRefundService.disable(disableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String PhysicalDeleteOperate(@RequestBody PhysicalDeleteParamDto paramDto) {
		...
		boolean isFlag = accountRefundService.physicalDelete(physicalDeleteDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
