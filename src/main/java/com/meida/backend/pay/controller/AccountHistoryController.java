 ...
 */
@Controller("backendAccountHistoryController")
@RequestMapping("/backend/pay/accountHistory")
public class AccountHistoryController {
	...
	@RequestMapping("/list")
	public String list() {
        return "/backend/pay/AccountHistory/list";
	}

	@RequestMapping("/detail")
	public String detail() {
        return "/backend/pay/AccountHistory/detail";
    }
	...
	public String enableOperate(@RequestBody EnableParamDto paramDto) {
		...
		boolean isFlag = accountHistoryService.enable(enableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String disableOperate(@RequestBody DisableParamDto paramDto) {
		...
		boolean isFlag = accountHistoryService.disable(disableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String PhysicalDeleteOperate(@RequestBody PhysicalDeleteParamDto paramDto) {
		...
		boolean isFlag = accountHistoryService.physicalDelete(physicalDeleteDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
