 ...
 */
@Controller("backendAccountPayableController")
@RequestMapping("/backend/pay/accountPayable")
public class AccountPayableController {
	...
	@RequestMapping("/list")
	public String list() {
        return "/backend/pay/AccountPayable/list";
	}

	@RequestMapping("/detail")
	public String detail() {
        return "/backend/pay/AccountPayable/detail";
    }
	...
	public String enableOperate(@RequestBody EnableParamDto paramDto) {
		...
		boolean isFlag = accountPayableService.enable(enableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String disableOperate(@RequestBody DisableParamDto paramDto) {
		...
		boolean isFlag = accountPayableService.disable(disableDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
	...
	public String PhysicalDeleteOperate(@RequestBody PhysicalDeleteParamDto paramDto) {
		...
		boolean isFlag = accountPayableService.physicalDelete(physicalDeleteDto);
		if (isFlag) {
			ResultMessage resultMessage = new ResultMessage();
			resultMessage.setCode(EErrorCode.Success);
			resultMessage.setMessage("操作成功.");
