...
public class AlipayPageResultTradeRefund {
    ...
    public String getRefund_preset_paytool_list() {
        return refund_preset_paytool_list;
    }

    public void setRefund_preset_paytool_list(String refund_preset_paytool_list) {
        this.refund_preset_paytool_list = refund_preset_paytool_list;
    }

    public String getRefund_charge_amount() {
        return refund_charge_amount;
    }

    public void setRefund_charge_amount(String refund_charge_amount) {
        this.refund_charge_amount = refund_charge_amount;
    }
