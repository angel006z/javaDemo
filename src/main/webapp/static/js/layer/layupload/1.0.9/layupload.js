...
; !function () {
    "use strict";
    function layupload(options) {
        var skin = 'layuploadcss';
        layupload.dir = 'dir' in layupload ? layupload.dir : Upload.getpath + '/skin/layupload.css';
        new Upload(options);
        if (layupload.dir && !doc[id](skin)) {
            Upload.use(layupload.dir, skin);
        }
    };
    layupload.v = "1.0.9";
   ...
   Upload.getpath = (function () {
       var js = document.scripts, jsPath = js[js.length - 1].src;
       return jsPath.substring(0, jsPath.lastIndexOf("/") + 1);
   }())

   Upload.use = function (lib, id) {
       var link = doc.createElement('link');
       link.type = 'text/css';
       link.rel = 'stylesheet';
       link.href = layupload.dir;
       id && (link.id = id);
   ...
   Upload.prototype.action = function (input, type) {
    ...
    "function" === typeof define ? define(function () {
        return layupload;
    }) : "undefined" != typeof exports ? module.exports = layupload : window.layupload = layupload;
