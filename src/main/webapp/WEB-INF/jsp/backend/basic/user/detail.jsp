...
<body data-base-path="<%=basePath%>" class="RightBody">
	<form id="form1">
		...
		<div class="OperateButtonArea">
			...
			<div id="OperateButton" class="OOperateButton">
				@Html.Raw(ViewBag.OperateButton)</div>
		</div>
		<!--OperateButton End-->
		<!--Content Begin-->
		<div class="ContentArea" id="ContentArea">
			<table class="tbdetail">
				<tr>
					...
					<td style="text-align: left;"><input type="text"
						class="inputnull input" id="txtRealName" /></td>
				</tr>
				<tr>
					<td style="text-align: right;">街道：</td>
					<td style="text-align: left;"><select class="inputnull select"
						id="ddlStreetId"> @Html.Raw(ViewBag.GetStreetId)
					</select></td>
					<td style="text-align: right;">执法证号：</td>
					<td style="text-align: left;"><input type="text"
						class="inputnull input" id="txtZfNo" /></td>
				</tr>

				<tr>
					<td style="text-align: right;">所属中队：</td>
					<td style="text-align: left;"><select class="inputnull select"
						id="ddlZdId"> @Html.Raw(ViewBag.GetZdId)
					</select></td>
					<td style="text-align: right;">角色：</td>
					<td style="text-align: left;"><select class="inputnull select"
						id="ddlRoleId"> @Html.Raw(ViewBag.GetRoleId)
					</select></td>
				</tr>
				<tr>
					<td style="text-align: right;">部门：</td>
					<td style="text-align: left;"><select class="inputnull select"
						id="ddlDeptId"> @Html.Raw(ViewBag.GetDeptId)
					</select></td>
					<td style="text-align: right;"></td>
					<td style="text-align: left;"><select class="inputnull select"
						style="display: none;" id="ddlHomePath">
				...
				<tr>
					...
					<td style="text-align: left;"><input type="password"
						class="inputnull input" id="txt_Pwd" /><span
						style="margin-left: 5px;">默认密码<span style="color: red;">111111</span></span>
					</td>
					<td style="text-align: right;">确认密码：</td>
					<td style="text-align: left;"><input type="password"
						class="inputnull input" id="txt_RePwd" /></td>
				</tr>
				<tr>
	...
	<!--PageNodeId Begin-->
	<input type="hidden" id="txtListPageNodeId"
		value="@ViewBag.ListPageNodeId" />
	<!--PageNodeId End-->
</body>
</html>
			...
			$.ajax({
				...
				success : function(response) {
					...
					case 0://错误
						...
						return;
					case 1://返回正确数据
						MISSY.iSuccessMessage(response.MessageContent,
								ClickBack);
						break;
					case 2://请求地址不正确
						MISSY.iNoFound(response.MessageContent);
