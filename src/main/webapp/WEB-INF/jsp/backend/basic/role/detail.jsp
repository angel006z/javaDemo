...
<body class="RightBody">
	<form id="form1">
		...
		<div class="OperateButtonArea">
			<div id="divOTitle" class="OTitle">角色管理</div>
		...
		<div class="ContentArea" id="ContentArea">
			<table class="tbdetail">
				<tr>
					...
					<td style="text-align: right;"><span class="inputnull must">*</span>角色名称：
					</td>
					<td style="text-align: left;"><input type="text"
						class="inputnull input" id="txtRoleName" /></td>
					<td style="text-align: right; width: 20%;">角色编号：</td>
					<td style="text-align: left;"><input type="text"
						class="inputnull input" id="txtRoleCode" /></td>
				</tr>
				<tr>
...
function initSingle() {
	...
	$.ajax({
		...
		success : function(response) {
			...
			$("#txtRoleCode").val(responseItem.roleCode);
			$("#txtRoleName").val(responseItem.roleName);
